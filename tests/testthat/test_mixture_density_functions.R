...
test_that("numerical inversion quantile function do not produce errors", {
  expect_output(str(qmix(ps = c(0.1, 0.2),
                            locations = c(0, 0),
                            scales = c(1, 1),
                            weights = c(0.5, 0.5),
                            distr.k = 1
  ...
  expect_output(str(qmix(ps = c(0.1, 0.9),
                         ...
                         weights = c(0.0134999915, 0.0062952205, 0.0042048405, 0.0022923494, 0.0018878532, 0.0018635573, 0.0014329597, 0.0012816347, 0.0007893726, 0.0004881692
